...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth.antMatchers("/api/**","/api/auth/register/**", "/api/auth/login/**","/v2/api-docs/**","/swagger-ui/**","/swagger-resources/**").permitAll().anyRequest().authenticated())
